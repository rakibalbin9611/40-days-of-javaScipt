...
const promise = new Promise((resolve, reject) => {
  loading = true;
  // make a network(API call/ IO Operation)
...
getUser
  .then(function (user) {
    ...
    if (!user.permissions.includes("dr")) {
      throw new Error("You are not allow to access in HR module");
    }
...
// How to Cancel a Promise => their is no way to cancel Promise.
